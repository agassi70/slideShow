...
/***/ function(module, exports) {
	...
	function episode14() {
	    ...
	    imgElements[58].querySelector('img').style.border = 'none';
	    animation.anims.push(imgElements[58].animate({
	        transform: ['translate(-' + parseInt(width) * 0.18 + 'px, -' + parseInt(height) * 0.15 + 'px) scale(0.6) rotate(-10deg)', 'translate(-' + parseInt(width) * 0.18 + 'px, -' + parseInt(height) * 0.15 + 'px) scale(0.6) rotate(-10deg)', 'translate(-' + parseInt(width) * 0.18 + 'px, -' + parseInt(height) * 0.15 + 'px) scale(0.6) rotate(-10deg)', 'translate(0, 0) scale(1) rotate(0)', 'translate(0, 0) scale(1) rotate(0)', 'scale(2.8)'],
	    ...
	    animation.anims.push(imgElements[59].animate({
	        transform: ['translate(' + parseInt(width) * 0.22 + 'px, 0) scale(0.6) rotate(10deg)', 'translate(0, 0) scale(1) rotate(0deg)', 'translate(0, 0) scale(1) rotate(0deg)', 'translate(0, 0) scale(2.8) rotate(0deg)'],
	        opacity: [0, 1, 1, 1, 0]
	    }, {
	        duration: 5000,
	        delay: 1800,
